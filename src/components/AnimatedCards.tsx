...
const icons = {
  ...
  flexible: (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
      ...
      <circle cx="18" cy="28" r="3" stroke="url(#grad3)" strokeWidth="1.5" />
      <circle cx="30" cy="28" r="3" stroke="url(#grad3)" strokeWidth="1.5" />
...
const methodIcons = {
  conversation: (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
      ...
      <circle cx="13" cy="17" r="1.5" fill="url(#gradM1)" />
      <circle cx="17" cy="17" r="1.5" fill="url(#gradM1)" />
      <circle cx="21" cy="17" r="1.5" fill="url(#gradM1)" />
      <path d="M26 31h8" stroke="url(#gradM1)" strokeWidth="2" strokeLinecap="round" />
      <path d="M26 35h5" stroke="url(#gradM1)" strokeWidth="2" strokeLinecap="round" opacity="0.5" />
      <defs>
        <linearGradient id="gradM1" x1="0" y1="0" x2="48" y2="48">
          <stop offset="0%" stopColor="#8b5cf6" />
          <stop offset="100%" stopColor="#ec4899" />
        </linearGradient>
      </defs>
  ...
  grammar: (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
      ...
      <path d="M14 36h10" stroke="url(#gradM2)" strokeWidth="2" strokeLinecap="round" opacity="0.2" />
      <defs>
        <linearGradient id="gradM2" x1="0" y1="0" x2="48" y2="48">
          <stop offset="0%" stopColor="#8b5cf6" />
          <stop offset="100%" stopColor="#06b6d4" />
        </linearGradient>
      </defs>
  ...
  exams: (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
      ...
      <path d="M18 33h8" stroke="url(#gradM3)" strokeWidth="2" strokeLinecap="round" opacity="0.3" />
      ...
      <defs>
        <linearGradient id="gradM3" x1="0" y1="0" x2="48" y2="48">
          <stop offset="0%" stopColor="#8b5cf6" />
          <stop offset="100%" stopColor="#f59e0b" />
        </linearGradient>
      </defs>
    ...
    <div className="grid sm:grid-cols-3 gap-6">
      {items.map((item, i) => (
        <motion.div
          ...
          className="bg-white rounded-2xl p-8 text-center group cursor-default relative overflow-hidden border border-black/5 shadow-sm hover:shadow-lg transition-shadow"
        >
          <div className="absolute top-0 left-1/4 right-1/4 h-px bg-gradient-to-r from-transparent via-[#8b5cf6]/0 group-hover:via-[#8b5cf6]/40 to-transparent transition-all duration-500" />
    ...
    <div className="grid sm:grid-cols-3 gap-6">
      {items.map((item, i) => (
        ...
        >
          ...
          <div className="relative z-10">
            <div className="text-xs text-[#8b5cf6]/50 font-mono mb-4">
              0{i + 1}
            </div>
            <div className="flex justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
